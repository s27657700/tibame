...
def draw_bbox(image, bboxes, CLASSES=YOLO_COCO_CLASSES, show_label=True, show_confidence = True, Text_colors=(255,255,0), rectangle_colors='', tracking=False):
    ...
    for i, bbox in enumerate(bboxes):
        ...
        bbox_list.append((x1, y1))
        bbox_list.append((x2, y2))
        img_coorlist.append(bbox_list)
        ...
        if show_label:
            ...
            try:
                ...
                # car_name = "{}".format(NUM_CLASS[class_ind])
                # print(int(class_ind))
            ...
            # put text above rectangle
                ...
                errtext =  'please upload car image again'

    return image,img_coorlist,errtext
...
def detect_image(Yolo, image_path, output_path, input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
    ...
    image,coor,err_text = draw_bbox(original_image, bboxes, CLASSES=CLASSES, rectangle_colors=rectangle_colors)
